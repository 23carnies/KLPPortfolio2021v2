...
const About = () => {
    ...
    return ( 
            ...
            <Box>
                ...
                <AboutText>I have a passion for rowing, a sport of focus and dedication. I bring these skills with me to every project. With a fondness for spoken languages, travel, and fitness, I want to see the world; and see what positive change I can be in it.</AboutText>
                </div>
                </Box>
            </Section>
    );
